...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( Ok<T> value)?  ok,TResult Function( Failure<T> value)?  failure,required TResult orElse(),}){
final _that = this;
switch (_that) {
case Ok() when ok != null:
return ok(_that);case Failure() when failure != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( Ok<T> value)  ok,required TResult Function( Failure<T> value)  failure,}){
final _that = this;
switch (_that) {
case Ok():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( Ok<T> value)?  ok,TResult? Function( Failure<T> value)?  failure,}){
final _that = this;
switch (_that) {
case Ok() when ok != null:
return ok(_that);case Failure() when failure != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T value)?  ok,TResult Function( String message)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Ok() when ok != null:
return ok(_that.value);case Failure() when failure != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( T value)  ok,required TResult Function( String message)  failure,}) {final _that = this;
switch (_that) {
case Ok():
return ok(_that.value);case Failure():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T value)?  ok,TResult? Function( String message)?  failure,}) {final _that = this;
switch (_that) {
case Ok() when ok != null:
return ok(_that.value);case Failure() when failure != null:
return failure(_that.message);case _:
